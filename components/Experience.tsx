          ...
          <div className="exp-card glass-card p-8 rounded-3xl border border-white/5 hover:border-neonPurple/30 transition-all hover:shadow-[0_0_30px_rgba(176,38,255,0.1)]">
            ...
            <div className="space-y-8 border-l-2 border-white/10 ml-3 pl-8 relative">
              ...
              <div className="relative group">
                ...
                <h4 className="text-xl font-bold text-white group-hover:text-neonPurple transition-colors">Developer & Core Creator </h4>
                <p className="text-neonCyan text-sm mb-2 font-mono">Independent • 2023-2025 - Present </p>
                <p className="text-gray-400 text-sm"> Built numerous personal projects driven by curiosity and passion for development, constantly experimenting with new ideas.</p>
                <p className="text-gray-400 text-sm mt-1"> Explored a wide range of AI tools, modern frameworks, and emerging technologies to enhance skills and create innovative solutions.</p></div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4 p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-colors transform hover:-translate-y-1 duration-300">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm mt-1">Reported critical vulnerabilities including IDOR, authentication flaws, and security misconfigurations to my university, helping strengthen their systems.<br></br> Secured multiple company and government-related platforms by identifying threats and assisting in implementing protective measures.</p>
                </div>
              </div>
